...
<body style="background: url(img/retro.jpg);">
	...
	<div class="container" style='padding-top: 55px;' position: relat ive;>
			
			<center><img src="img/ydp2.png" width="38%" style='margin: auto;'/></br>
					<img src="img/y.png" width="40%" style='margin: auto;'/>
		<div id="subscribe">
		  <h4><font color="red"> Invalid username or password</font></h4>
			<form action="auth.php" method="POST" >
                ...
                <button class="btn btn-large btn-primary" name="action">Login</button>
